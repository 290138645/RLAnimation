...
#define buttonMenuColor [UIColor colorWithRed:0 green:0.722 blue:1 alpha:1]



@interface RLDrawerView ()

@property (nonatomic,strong) CADisplayLink *displayLink; //定时器对象，不懂得可以去百度哦
@property (nonatomic,assign) NSInteger animationCount; //动画数量

@end

@implementation RLDrawerView
{
...
-(id)initWithTitles:(NSArray *)titles{
    return [self initWithTitles:titles withButtonHeight:buttonHeight withMenuColor:buttonMenuColor withBackBlurStyle:UIBlurEffectStyleDark];
}
